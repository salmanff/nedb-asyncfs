...
if (!dbFS) {
  console.log('trying fair os')
  Custom_FS = require('./dbfs_fdsFairOs.js')
  cred_contents = fs.existsSync("./env/.fdsFairOs_credentials.js")? require("./.fdsFairOs_credentials.js") : null
  console.log({cred_contents})
  if (Custom_FS && cred_contents && cred_contents.userName && cred_contents.fdsPass) {
    dbFS = new Custom_FS(cred_contents, { doNotPersistOnLoad: false });
    if (dbFS) name = 'fdsFairOs'
  }
}
